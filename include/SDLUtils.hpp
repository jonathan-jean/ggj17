...
#ifndef BASIC_SDLUTILS_HPP
#define BASIC_SDLUTILS_HPP
...
*/
void renderTexture(SDL_Texture *tex, SDL_Renderer *ren, int x = 0, int y = 0){
	...
	//Set 4th parameter to NULL if you want to scale image to window
